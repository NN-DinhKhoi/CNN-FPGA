...
#
# Script generated by Vivado on Fri Mar 28 10:36:21 +0700 2025
...
#
# Usage        : ila_top.sh
#                ila_top.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_top.sh [-reset_run]
#                ila_top.sh [-reset_log]
#                ila_top.sh [-help]
#
...
#                script (type 'ila_top.sh -help' for more information).
#
...
# script info
echo -e "ila_top.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_top.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../project_1.gen/sources_1/ip/ila_top/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../project_1.gen/sources_1/ip/ila_top/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ila_top xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ila_top -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ila_top_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: ila_top.sh [-step]\n\
Usage: ila_top.sh [-lib_map_path]\n\
Usage: ila_top.sh [-reset_run]\n\
Usage: ila_top.sh [-reset_log]\n\
Usage: ila_top.sh [-keep_index]\n\
