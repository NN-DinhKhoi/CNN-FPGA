...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../tmp_edit_project.gen/sources_1/ip/ila_test/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../tmp_edit_project.gen/sources_1/ip/ila_test/hdl/verilog" \
