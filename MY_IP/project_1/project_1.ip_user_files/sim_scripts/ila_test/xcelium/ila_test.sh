...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../project_1.gen/sources_1/ip/ila_test/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../project_1.gen/sources_1/ip/ila_test/hdl/verilog" \
