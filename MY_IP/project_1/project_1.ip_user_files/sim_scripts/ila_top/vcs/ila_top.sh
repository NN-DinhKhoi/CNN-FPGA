...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../project_1.gen/sources_1/ip/ila_top/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../project_1.gen/sources_1/ip/ila_top/hdl/verilog" \
...
reset_run()
{
  files_to_remove=(ucli.key ila_top_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ila_top_simv.daidir vcs_lib c.obj)
