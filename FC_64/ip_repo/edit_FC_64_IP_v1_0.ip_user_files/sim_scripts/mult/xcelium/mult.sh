...
#
# Script generated by Vivado on Sat Mar 15 20:02:27 +0700 2025
...
# script info
echo -e "mult.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.mult
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/GiaPhuc/Project_1/Dense_0/FC_64/ip_repo/edit_FC_64_IP_v1_0.cache/compile_simlib/xcelium"
  fi
